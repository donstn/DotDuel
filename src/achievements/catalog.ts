...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'triple-impossible', category: 'mastery', title: 'Nightmare Slayer', desc: 'Beat the Impossible Bot on all three shapes.', icon: 'nightmare', tier: 5 },

  // ---- F: skill / blowouts (3) ----
  { id: 'blowout-50', category: 'skill', title: 'Domination', desc: 'Win a game by 50 points or more.', icon: 'blowout', tier: 3 },
  { id: 'blowout-100', category: 'skill', title: 'Annihilation', desc: 'Win a game by 100 points or more.', icon: 'blowout', tier: 5 },
  { id: 'shutout', category: 'skill', title: 'Flawless', desc: 'Win a game without your opponent scoring a single point.', icon: 'shield', tier: 4 },
